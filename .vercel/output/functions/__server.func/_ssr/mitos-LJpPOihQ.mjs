...
//#region node_modules/.nitro/vite/services/ssr/assets/mitos-LJpPOihQ.js
...
var MYTHS = [
	{
		...
		better: "A dopamina é um neuromodulador cujo efeito depende do circuito, do receptor e do contexto. Em alguns paradigmas, seu sinal acompanha erro de predição de recompensa.",
	...
	},
	{
		...
		better: "A amígdala participa de circuitos envolvidos em aprendizagem e no processamento de estímulos biologicamente relevantes. Em determinadas situações, sua atividade contribui para respostas associadas à ameaça.",
	...
	},
	{
		...
		better: "O cortisol é um glicocorticoide que participa da mobilização energética e de múltiplos ajustes. O eixo HPA é um dos efetores da resposta a desafios, não o sinônimo de estresse.",
	...
	},
	{
		...
		better: "Há especializações relativas, mas decisão, linguagem e afeto recrutam redes bilaterais. Lado esquerdo/direito não é uma explicação global do comportamento.",
	...
	},
	{
		...
		better: "O encéfalo é um sistema integrado, com circuitos que cruzam tronco, diencéfalo e córtex. Processos rápidos e lentos existem como descrição cognitiva, não como anatomia de três cérebros.",
	...
	},
	{
		...
		better: "O sistema nervoso pode alterar sinapses e, em certos casos, estrutura, de modo dependente da experiência — dentro de restrições.",
	...
	},
	{
		...
		better: "Neuroimagem pode ser consistente com a participação de uma rede em uma tarefa. Não substitui causalidade nem define o conteúdo subjetivo.",
	...
	},
	{
		...
		better: "A serotonina é um neuromodulador com ações diversas. Nenhuma molécula 'é' um estado psicológico.",
	...
	},
	{
		...
		better: "Diferentes redes são recrutadas conforme a demanda, mas o tecido nervoso é metabolicamente caro e amplamente utilizado ao longo do tempo.",
	...
	},
	{
		...
		better: "Adapte exemplos e carga cognitiva; não prenda o conteúdo a um canal sensorial como se fosse um tipo sanguíneo cognitivo.",
...
function MythsPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
			...
			children: "Simplificações que o curso recusa. O veredito não é um insulto — é um ajuste de modelo."
		})] }), MYTHS.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
			className: "rounded-xl border border-border bg-bg-elevated p-5",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-xs font-medium uppercase tracking-wide text-danger",
					children: "Mito"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-xs font-medium uppercase tracking-wide text-ok",
					children: "Veredito"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: m.conceptIds.map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
