...
var grokOgIdentity = { "site": {
	...
	"card": "custom",
	"color": "245A4A",
	"description": "Editorial neuroscience learning — concepts, mechanisms, and mastery.",
	"image": "/og.jpg"
} };
//#endregion
...
var findRouteRules = /* @__PURE__ */ (() => {
	const $0 = [{
		...
		handler: headers,
		options: { "content-type": "application/manifest+json; charset=utf-8" }
	}], $1 = [{
		name: "headers",
		route: "/manifest.json",
		handler: headers,
	...
	return (m, p) => {
		...
		else if (p === "/manifest.json") r.unshift({ data: $1 });
		let s = p.split("/");
		if (s.length > 1) {
...
var _lazy_WCNxWO = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_WCNxWO
	};
	return ((_m, p) => {
		return {
			data,
